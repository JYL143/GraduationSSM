...
<div style="height: 1080px;width: 100%;background:  rgb(250,250,250)">
    ...
    <div style="height: 980px;width: 972px;background: #FFFFFF;margin-left: 19px;margin-top: 20px;float: left;">
        <div style="height: 60px;width: 972px;float: left;background: #0F9E5E">
            ...
            <a href="/yunmi/order/1" style="font-size: 18px;margin-left: 130px;display:block;padding-top: 15px;color: black;float: left">未发货</a>
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        ...
                        <c:if test="${!pageinfo.hasPreviousPage}"> <%-- 是否有上一页，没有就显示禁用状态--%>
                            <li class="disabled"><a   href="/yunmi/order/1">首页</a></li>
                            <li class="disabled" >
                                <a  href="/yunmi/order/1?pn=${pageinfo.pageNum-1}" aria-label="Previous">
                                    <span aria-hidden="true">&laquo;</span>
                                </a>
                            </li>
                        </c:if>
                        <c:if test="${pageinfo.hasPreviousPage}"> <%-- 是否有上一页，有就显示正常--%>
                            <li><a  href="/yunmi/order/1">首页</a></li>
                            <li>
                                <a href="/yunmi/order/1?pn=${pageinfo.pageNum-1}" aria-label="Previous">
                                    <span aria-hidden="true">&laquo;</span>
                                </a>
                        ...
                        <c:forEach items="${pageinfo.navigatepageNums}" var="page_Num">
                            ...
                            <c:if test="${page_Num!=pageinfo.pageNum}">
                                <li><a href="/yunmi/order/1?pn=${page_Num}">${page_Num}</a></li>
                            </c:if>
                        ...
                        <c:if test="${!pageinfo.hasNextPage}">
                            <li class="disabled">
                                <a href="/yunmi/order/1?pn=${pageinfo.pageNum+1}" aria-label="Next">
                                    <span aria-hidden="true">&raquo;</span>
                                </a>
                            </li>
                            <li class="disabled"><a href="/yunmi/order/1?pn=${pageinfo.pages}">末页</a></li>
                        </c:if>
                        ...
                        <c:if test="${pageinfo.hasNextPage}">
                            ...
                            <li><a href="/yunmi/order/1?pn=${pageinfo.pages}">末页</a></li>
                        </c:if>
    ...
    function  orders_remind1(orderid) {
        ...
        $.ajax({
            ...
            success:function (result) {
                alert("提醒发货成功！");
                window.location.href="/yunmi/order/1?pn="+pageNUM;//跳转到当前页码那一页
            }
        });
