...
<div class="main-home">
    <div class="container ">
        <!---->
        <div class="home-brick-row-3-box home-brick-box-1">
            <div class="hot-product">
                <div class="box-hd">
                    <c:if test="${commoditynum>8}">
                        <h2 class="title" style="font-size: 16px">搜索到${commoditynum}条结果，只展示前8项结果，请缩小查询范围</h2>
                    </c:if>
                    <c:if test="${commoditynum<=8}">
                        <h2 class="title">搜索到${commoditynum}条结果</h2>
                    </c:if>
                </div>
                <div class="box-bd">
                    <ul class="review-list clear">

                            <c:forEach items="${listC}" var="list"  begin="0" end="0"  varStatus="xh">
                                <li class="review-item review-item-first">
                                    <div class="figure figure-img" style="height: 260px">
                                        <a href="/yunmi/commodity?commodityid=${list.commodityid}">
                                            <img src="<%=path %>/upload/${listC.get(xh.index).images}"  style="width: 240px;height: 240px;margin-left: 30px;padding-top: 20px">
                                        </a>
                                    </div>
                                    <div style="margin-top: 20px;text-align: center;height: 30px;font-size: 17px;color: black">
                                        <a href="/yunmi/commodity?commodityid=${list.commodityid}">${listC.get(xh.index).name}</a>
                                    </div>
                                    <div style="margin-top: 10px;text-align: center;height: 30px;font-size: 14px;">${listC.get(xh.index).subtitle}</div>
                                    <div  style="margin-top: 10px;text-align: center;height: 30px;font-size: 15px;color:#ff6700">${listC.get(xh.index).price}元</div>

                                </li>
                            </c:forEach>
                            <c:forEach items="${listC}" var="list"  begin="1" end="3"  varStatus="xh">
                            ...
                            <c:forEach items="${listC}" var="list"  begin="4" end="4"  varStatus="xh">
                                <li class="review-item review-item-first">
                                    <div class="figure figure-img" style="height: 260px">
                                        <a href="/yunmi/commodity?commodityid=${list.commodityid}">
                                            <img src="<%=path %>/upload/${listC.get(xh.index).images}"  style="width: 240px;height: 240px;margin-left: 30px;padding-top: 20px">
                            ...
                            <c:forEach items="${listC}" var="list"  begin="5" end="7"  varStatus="xh">
                                <li class="review-item ">
                                    <div class="figure figure-img" style="height: 260px">
                                        <a href="/yunmi/commodity?commodityid=${list.commodityid}">
                                            <img src="<%=path %>/upload/${listC.get(xh.index).images}"  style="width: 240px;height: 240px;margin-left: 30px;padding-top: 20px">
