...
<div id="page-wrapper">
    <div class="container" >
        ...
        <div>
            <span style="color: black;font-size: 25px">未处理订单</span>
        </div>
        <div style="margin-top: 20px;margin-left: 20px">

            <form  action="/order/Search?status=0" method="post">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div style="float: left">
                            ...
                            <a  style="width: 90px;height: 35px;margin-top: 7px;margin-left: 10px;"  href="/order/orders_status0" class="btn btn-primary"  >返回查询</a>
                        </div>
                ...
                <table class="table table-hover" >
                    ...
                    <c:forEach items="${pageinfo.list}" var="orders">
                        <tr>
                            ...
                            <th><p style="color: red">未处理</p></th>
                            <th>
                                <button  onclick="findAll_orderitem(${orders.orderid})" class="btn btn-success btn-sm"  >查看详情</button>
                                <a  href="/order/orders_status_edit1?orderid=${orders.orderid}&pageNum=${pageinfo.pageNum}&status=0"  onclick="sl()"  class="btn btn-warning btn-sm ">确认受理</a>
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        ...
                        <c:if test="${!pageinfo.hasPreviousPage}"> <%-- 是否有上一页，没有就显示禁用状态--%>
                            <li class="disabled"><a   href="/order/orders_status0">首页</a></li>
                            <li class="disabled" >
                                <a  href="/order/orders_status0?pn=${pageinfo.pageNum-1}" aria-label="Previous">
                                    <span aria-hidden="true">&laquo;</span>
                                </a>
                            </li>
                        </c:if>
                        <c:if test="${pageinfo.hasPreviousPage}"> <%-- 是否有上一页，有就显示正常--%>
                            <li><a  href="/order/orders_status0">首页</a></li>
                            <li>
                                <a href="/order/orders_status0?pn=${pageinfo.pageNum-1}" aria-label="Previous">
                                    <span aria-hidden="true">&laquo;</span>
                                </a>
                        ...
                        <c:forEach items="${pageinfo.navigatepageNums}" var="page_Num">
                            ...
                            <c:if test="${page_Num!=pageinfo.pageNum}">
                                <li><a href="/order/orders_status0?pn=${page_Num}">${page_Num}</a></li>
                            </c:if>
                        ...
                        <c:if test="${!pageinfo.hasNextPage}">
                            <li class="disabled">
                                <a href="/order/orders_status0?pn=${pageinfo.pageNum+1}" aria-label="Next">
                                    <span aria-hidden="true">&raquo;</span>
                                </a>
                            </li>
                            <li class="disabled"><a href="/order/orders_status0?pn=${pageinfo.pages}">末页</a></li>
                        </c:if>
                        ...
                        <c:if test="${pageinfo.hasNextPage}">
                            ...
                            <li><a href="/order/orders_status0?pn=${pageinfo.pages}">末页</a></li>
                        </c:if>
