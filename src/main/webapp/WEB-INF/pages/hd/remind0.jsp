                ...
                <table class="table table-hover" >
                    ...
                    <c:forEach items="${pageinfo.list}" var="reminds">
                        <tr>
                            ...
                            <th><span style="color: green">请求受理</span></th>
                            <th><a  href="#" onclick="orders_status_edit1(${reminds.orderid})" class="btn btn-warning btn-sm ">确认受理</a></th>
                        </tr>
...
<script>
    ...
    function orders_status_edit1(orderid) {
        console.log(orderid)
        $.ajax({
            url:"/remind/orders_status_edit1?orderid="+orderid,      //k3是你点击的那个发货id，全局变量通过点击按钮的时候保存id
            type:"POST",
            success:function (result) {
                alert("受理成功！");
                 window.location.href="/remind/remind0?pn="+pageNUM;//跳转到当前页码那一页
            },
            error:function(){
                alert("请求失败");
            }
