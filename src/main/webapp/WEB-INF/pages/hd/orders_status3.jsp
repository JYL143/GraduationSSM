...
<div id="page-wrapper">
    <div class="container" >
        ...
        <div>
            <span style="color: black;font-size: 25px">已收货订单</span>
        </div>
        <div style="margin-top: 20px;margin-left: 20px">

            <form  action="/order/Search?status=3" method="post">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div style="float: left">
                            ...
                            <a  style="width: 90px;height: 35px;margin-top: 7px;margin-left: 10px;"  href="/order/orders_status3" class="btn btn-primary"  >返回查询</a>
                        </div>
                ...
                <table class="table table-hover" >
                    ...
                    <c:forEach items="${pageinfo.list}" var="orders">
                        <tr>
                            ...
                            <th>${orders.closetimeStr}</th>
                            <th><p style="color: #9b58b5">已收货</p></th>
                            <th>
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        ...
                        <c:if test="${!pageinfo.hasPreviousPage}"> <%-- 是否有上一页，没有就显示禁用状态--%>
                            <li class="disabled"><a   href="/order/orders_status3">首页</a></li>
                            <li class="disabled" >
                                <a  href="/order/orders_status3?pn=${pageinfo.pageNum-1}" aria-label="Previous">
                                    <span aria-hidden="true">&laquo;</span>
                                </a>
                            </li>
                        </c:if>
                        <c:if test="${pageinfo.hasPreviousPage}"> <%-- 是否有上一页，有就显示正常--%>
                            <li><a  href="/order/orders_status3">首页</a></li>
                            <li>
                                <a href="/order/orders_status3?pn=${pageinfo.pageNum-1}" aria-label="Previous">
                                    <span aria-hidden="true">&laquo;</span>
                                </a>
                        ...
                        <c:forEach items="${pageinfo.navigatepageNums}" var="page_Num">
                            ...
                            <c:if test="${page_Num!=pageinfo.pageNum}">
                                <li><a href="/order/orders_status3?pn=${page_Num}">${page_Num}</a></li>
                            </c:if>
                        ...
                        <c:if test="${!pageinfo.hasNextPage}">
                            <li class="disabled">
                                <a href="/order/orders_status3?pn=${pageinfo.pageNum+1}" aria-label="Next">
                                    <span aria-hidden="true">&raquo;</span>
                                </a>
                            </li>
                            <li class="disabled"><a href="/order/orders_status3?pn=${pageinfo.pages}">末页</a></li>
                        </c:if>
                        ...
                        <c:if test="${pageinfo.hasNextPage}">
                            ...
                            <li><a href="/order/orders_status3?pn=${pageinfo.pages}">末页</a></li>
                        </c:if>
