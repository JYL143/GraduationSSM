...
<!-- 横条下拉加搜索栏  -->
<!--内容-->
<div style="height: 500px;width: 100%;background:  rgb(250,250,250)">
    <div style="height: 20px;width: 100%;margin-left: 147px;padding-top: 10px">首页&nbsp;&nbsp;/&nbsp;&nbsp;我的订单</div>
    <div style="height: 400px;width: 234px;background: #FFFFFF;margin-left: 147px;margin-top: 20px;float: left;">
    ...
    <!--右边-->
    <div style="height: 400px;width: 972px;background: #FFFFFF;margin-left: 19px;margin-top: 20px;float: left;">
        <div style="height: 60px;width: 972px;float: left;background: #0F9E5E">
            <c:if test="${status99==0}">
        ...
        <div>
            <p style="font-size: 24px;margin-left: 354px;margin-top: 169px">该分类下您还没有订单</p>
        </div>
