...
<div class="header-navbar container">
    <a href="/yunmi/index" class="logo fl">
        <img class="center" src="<%=path%>/qt_img/logo_top.png" style="margin-right: 22px">
    </a>
    <div class="nav fl">
...
<%--        <form class="search-form" style="width: 262px;">--%>
<%--            <label for="search">--%>
<%--            </label>--%>
<%--            <input id="searchinput" class="search-text" style="width: 245px">--%>
<%--            <a href="javascript:"  id="search">--%>
<%--                <img src="<%=path%>/qt_img/search.png" style="margin-left: 215px;height: 48px;width: 48px;margin-top: -4px">--%>
<%--            </a>--%>
...
<!--内容-->
<div style="height: 1080px;width: 100%;background:  rgb(250,250,250)">
    <div style="height: 20px;width: 100%;margin-left: 147px;padding-top: 10px;">首页&nbsp;&nbsp;/&nbsp;&nbsp;我的订单</div>
    <div style="height: 980px;width: 234px;background: #FFFFFF;margin-left: 147px;margin-top: 20px;float: left;">

        <p><a href="/yunmi/userinfo"  style="margin-left: 80px;display:block;margin-top: 50px;font-size: 15px;" >个人中心</a></p>
        <p><a href="/yunmi/order/5" class="leftp" style="color: #ff6700">我的订单</a></p>
    ...
    <!--右边-->
    <div style="height: 980px;width: 972px;background: #FFFFFF;margin-left: 19px;margin-top: 20px;float: left;">
        <div style="height: 60px;width: 972px;float: left;background: #0F9E5E">
            <a href="/yunmi/order/5" style="font-size: 18px;margin-left: 60px;display:block;padding-top: 15px;color: black;float: left">全部订单</a>
            <a href="/yunmi/order/0" style="font-size: 18px;margin-left: 110px;display:block;padding-top: 15px;color: #FFFFFF;float: left">未受理</a>
            <a href="/yunmi/order/1" style="font-size: 18px;margin-left: 130px;display:block;padding-top: 15px;color: #FFFFFF;float: left">未发货</a>
            <a href="/yunmi/order/2" style="font-size: 18px;margin-left: 130px;display:block;padding-top: 15px;color: #FFFFFF;float: left">待收货</a>
            <a href="/yunmi/order/3" style="font-size: 18px;margin-left: 130px;display:block;padding-top: 15px;color: #FFFFFF;float: left">已完成</a>
        </div>
        ...
        <div style="border-top: solid #DCDCDC 1px;width: 972px;height: 1px;float: left; margin-top: 30px"></div>
        <div style="width: 972px;height: 55px;float: left;">
            <%-- 因为需要ajax成功弹出对话框，隐藏的提交订单id--%>
            <p style="font-size: 14px;margin-top: 15px;float: left;width: 15px;display: none" id="orderidp">${orders.orderid}</p>
        <c:if test="${orders.orderstatus==0 ||orders.orderstatus==1}">
              <p style="font-size: 14px;margin-top: 15px;float: left;margin-left: 40px;width: 240px;">订单还未发货</p>
         </c:if>
        <c:if test="${orders.orderstatus==2 ||orders.orderstatus==3}">
             <p style="font-size: 14px;margin-top: 15px;float: left;margin-left: 40px;width: 60px;">订单号：</p>
              <p style="font-size: 14px;margin-top: 15px;float: left;margin-left: 10px;width: 180px;">${orders.orderbh}</p>
        </c:if>
            <c:if test="${orders.orderstatus==0 ||orders.orderstatus==1 }">
                <p style="font-size: 14px;margin-top: 15px;float: left;margin-left: 423px;width: 80px;">下单时间：</p>
                <p style="font-size: 14px;margin-top: 15px;float: left;margin-left: 5px;width: 180px;">${orders.ordertimeStr}</p>
            </c:if>
            <c:if test="${orders.orderstatus==2}">
                <p style="font-size: 14px;margin-top: 15px;float: left;margin-left: 396px;width: 80px;">发货时间：</p>
                <p style="font-size: 14px;margin-top: 15px;float: left;margin-left: 5px;width: 180px;">${orders.sendtimeStr}</p>
            </c:if>
            <c:if test="${orders.orderstatus==3}">
                <p style="font-size: 14px;margin-top: 15px;float: left;margin-left: 396px;width: 80px;">完成时间：</p>
                <p style="font-size: 14px;margin-top: 15px;float: left;margin-left: 5px;width: 180px;">${orders.closetimeStr}</p>
            </c:if>
        </div>
        ...
        <div style="height: 30px;width: 972px;float: left;margin-top: 5px;">
            <p style="font-size: 16px;padding-top: 5px;text-align: center;color: #ff6700;float: left;margin-left: 180px;width: 170px;text-align: center">商品名称</p>
            <p style="font-size: 16px;padding-top: 5px;text-align: center;color: #ff6700;float: left;width: 140px;text-align: center">商品配置</p>
            <p style="font-size: 16px;padding-top: 5px;text-align: center;color: #ff6700;float: left;width: 80px;text-align: center">单价</p>
            <p style="font-size: 16px;padding-top: 5px;text-align: center;color: #ff6700;float: left;width: 60px;text-align: center">数量</p>
            <p style="font-size: 16px;padding-top: 5px;text-align: center;color: #ff6700;float: left;width: 60px;text-align: center">运费</p>
            <p style="font-size: 16px;padding-top: 5px;text-align: center;color: #ff6700;float: left;width: 80px;text-align: center">实际付款</p>
            <p style="font-size: 16px;padding-top: 5px;text-align: center;color: #ff6700;float: left;width: 80px;margin-left: 10px;text-align: center">订单状态</p>
            <p style="font-size: 16px;padding-top: 5px;text-align: center;color: #ff6700;float: left;width: 100px;text-align: center">操作</p>
        </div>
        <div style="height: 150px;width: 972px;float: left;">
            <img  src="<%=path%>/upload/${orders.orderItems.images}" style="width: 130px;height: 130px;margin-left: 40px;float: left">
            <div style="width: 160px;height: 150px;margin-left: 20px;float: left">
                <p style="font-size: 15px;padding-top: 60px;text-align: center">${orders.orderItems.name}</p>
            </div>
            <div style="width: 140px;height: 150px;float: left">
                <p style="font-size: 15px;padding-top: 60px;text-align: center;">${orders.orderItems.commoditys.subtitle}</p>
            </div>
            <div style="width: 80px;height: 150px;float: left">
                <p style="font-size: 15px;padding-top: 60px;text-align: center">￥${orders.orderItems.price}</p>
            </div>
            <div style="width: 60px;height: 150px;float: left">
                <p style="font-size: 15px;padding-top: 60px;text-align: center">X&nbsp;&nbsp;${orders.orderItems.quantity}</p>
            </div>
            <c:if test="${orders.postage==0}">
                <div style="width: 60px;height: 150px;float: left">
            ...
            <c:if test="${orders.postage!=0}">
                <div style="width: 60px;height: 150px;float: left">
                    <p style="font-size: 15px;padding-top: 60px;text-align: center">${orders.postage}</p>
                </div>
            </c:if>

            <div style="width: 80px;height: 150px;float: left">
                <p style="font-size: 15px;padding-top: 60px;text-align: center">￥${orders.money}</p>
            </div>

             <div style="width: 80px;height: 150px;float: left">
                 <c:if test="${orders.orderstatus==0}">
                    <p style="font-size: 15px;padding-top: 60px;margin-left: 10px;text-align: center;color: #ff6700">等待受理</p>
                 </c:if>
                 <c:if test="${orders.orderstatus==1}">
                     <p style="font-size: 15px;padding-top: 60px;margin-left: 10px;text-align: center;color: #188ae2">等待发货</p>
                 </c:if>
                 <c:if test="${orders.orderstatus==2}">
                     <p style="font-size: 15px;padding-top: 60px;margin-left: 10px;text-align: center;color:#0F9E5E">等待收货</p>
                 </c:if>
                 <c:if test="${orders.orderstatus==3}">
                     <p style="font-size: 15px;padding-top: 60px;margin-left: 10px;text-align: center;color: #0F9E5E">经完成</p>
                 </c:if>
             </div>
            <div style="width: 120px;height: 150px;float: left">
                <c:if test="${orders.orderstatus==0}">
                    <p style="font-size: 15px;padding-top: 60px;text-align: center"><a  class=" btn-warning btn-sm" href="#"  id="id1" onclick="orders_remind0(${orders.orderid})">提醒受理</a></p>
                </c:if>
                <c:if test="${orders.orderstatus==1}">
                    <p style="font-size: 15px;padding-top: 60px;text-align: center"><a  class="btn-primary btn-sm" href="#"  onclick="orders_remind1(${orders.orderid})" >提醒发货</a></p>
                </c:if>
                <c:if test="${orders.orderstatus==2}">
                    <p style="font-size: 15px;padding-top: 60px;text-align: center"><a  class="btn-success btn-sm"   href="#"  onclick="orders_status_edit3(${orders.orderid})">确认收货</a></p>
                </c:if>
                <c:if test="${orders.orderstatus==3}">
                    <p style="font-size: 15px;padding-top: 60px;text-align: center">无</p>
                </c:if>
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        ...
                        <c:if test="${!pageinfo.hasPreviousPage}"> <%-- 是否有上一页，没有就显示禁用状态--%>
                            <li class="disabled"><a   href="/yunmi/order/5">首页</a></li>
                            <li class="disabled" >
                                <a  href="/yunmi/order/5?pn=${pageinfo.pageNum-1}" aria-label="Previous">
                                    <span aria-hidden="true">&laquo;</span>
                                </a>
                            </li>
                        </c:if>
                        <c:if test="${pageinfo.hasPreviousPage}"> <%-- 是否有上一页，有就显示正常--%>
                            <li><a  href="/yunmi/order/5">首页</a></li>
                            <li>
                                <a href="/yunmi/order/5?pn=${pageinfo.pageNum-1}" aria-label="Previous">
                                    <span aria-hidden="true">&laquo;</span>
                                </a>
                        ...
                        <c:forEach items="${pageinfo.navigatepageNums}" var="page_Num">
                            ...
                            <c:if test="${page_Num!=pageinfo.pageNum}">
                                <li><a href="/yunmi/order/5?pn=${page_Num}">${page_Num}</a></li>
                            </c:if>
                        ...
                        <c:if test="${!pageinfo.hasNextPage}">
                            <li class="disabled">
                                <a href="/yunmi/order/5?pn=${pageinfo.pageNum+1}" aria-label="Next">
                                    <span aria-hidden="true">&raquo;</span>
                                </a>
                            </li>
                            <li class="disabled"><a href="/yunmi/order/5?pn=${pageinfo.pages}">末页</a></li>
                        </c:if>
                        ...
                        <c:if test="${pageinfo.hasNextPage}">
                            ...
                            <li><a href="/yunmi/order/5?pn=${pageinfo.pages}">末页</a></li>
                        </c:if>
...
<script>
    ...
    //---------------------------------------点击提醒受理按钮------------------------------------------------------
    function  orders_remind0(orderid) {


        $.ajax({
            url:"/remind/orders_remind0?orderid="+orderid,
            type:"POST",
            success:function (result) {
                alert("提醒受理成功！");
                window.location.href="/yunmi/order/5?pn="+pageNUM;//跳转到当前页码那一页
            }
        });
    ...
    //---------------------------------------点击提醒发货按钮------------------------------------------------------
    function  orders_remind1(orderid) {


        $.ajax({
            url:"/remind/orders_remind1?orderid="+orderid,
            type:"POST",
            success:function (result) {
                alert("提醒发货成功！");
                window.location.href="/yunmi/order/5?pn="+pageNUM;//跳转到当前页码那一页
    ...
    //---------------------------------------点击收货按钮------------------------------------------------------
    function orders_status_edit3(orderid) {
        $.ajax({
            url:"/yunmi/orders_status_edit3?orderid="+orderid,
            type:"POST",
            success:function (result) {
                alert("确认收货成功！");
                window.location.href="/yunmi/order/5?pn="+pageNUM;//跳转到当前页码那一页
