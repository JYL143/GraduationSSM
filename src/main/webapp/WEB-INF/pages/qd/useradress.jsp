...
<!-- 横条下拉加搜索栏  -->
<!--内容-->
<div style="height: 480px;width: 100%;background:  rgb(250,250,250)">
    <div style="height: 20px;width: 100%;margin-left: 147px;padding-top: 10px">首页&nbsp;&nbsp;/&nbsp;&nbsp;个人中心</div>
    <div style="height: 380px;width: 234px;background: #FFFFFF;margin-left: 147px;margin-top: 10px;float: left;">
        ...
        <p><a href="/yunmi/useradress" class="leftp" style="color: #ff6700">收货地址</a></p>
        <p><a href="/login/userinfopassword"  class="leftp">修改密码</a></p>
        <p><a href="/yunmi/signOut"  class="leftp">注销用户</a></p>
    </div>
    <!--右边-->
    <div style="height: 380px;width: 972px;background: #FFFFFF;margin-left: 19px;margin-top: 10px;float: left;" id="useradressfrom">
        <div style="height: 30px;width: 972px;font-size:22px;margin-top: 20px;margin-left: 20px;color: #ff6700">收货地址</div>

            <c:forEach items="${useradress}">
            <form action="#" method="post">
                <div style="height: 40px;width: 972px;">
                    <p style="font-size: 18px;float: left;margin-left: 280px;margin-top:30px">收货地址:</p>
                    <input  type="text" style="font-size: 18px;float: left;height: 30px;width: 300px;margin-left: 30px;border: solid 1px #A9A9A9;margin-top: 30px" name="useraddress" value="${useradress.get(0).useraddress}"/>
                </div>
                <div style="height: 40px;width: 972px;">
                    <p style="font-size: 18px;float: left;margin-left: 280px;margin-top:30px">邮政编码:</p>
                    <input  type="text" style="font-size: 18px;float: left;height: 30px;width: 300px;margin-left: 30px;border: solid 1px #A9A9A9;margin-top: 30px" name="zipcode" value="${useradress.get(0).zipcode}"/>
...
<script>
    ...
    $("#submit1").click(function () {
        ...
        $.ajax({
            ...
            type:"post",
            data:$("#useradressfrom form").serialize(),
            success:function (result) {
                alert("修改收货地址和邮政编码成功！");
                window.location.href="/yunmi/useradress";
            }
        });
